...
(function () {
  ...
  wp.data.subscribe(function () {
    var results = wp.data.select("core/block-editor").getBlocks().filter(function (block) {
      return block.name == "ourplugin/our-gutenberg-block" && block.attributes.correctAnswer == undefined;
    });
...
wp.blocks.registerBlockType("ourplugin/our-gutenberg-block", {
  ...
  description: "Make Question With Answers to increase user experience more good",
  example: {
    attributes: {
...
function EditComponent(props) {
  ...
  return /*#__PURE__*/React.createElement("div", blockProps, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.BlockControls, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.AlignmentToolbar, {
    ...
    initialOpen: true
  }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelRow, null, /*#__PURE__*/React.createElement(react_color__WEBPACK_IMPORTED_MODULE_3__.ChromePicker, {
    ...
    return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Flex, {
      key: index
    }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.FlexBlock, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TextControl, {
      value: answer,
      onChange: function onChange(newValue) {
        var newAnswers = props.attributes.answers.slice();
