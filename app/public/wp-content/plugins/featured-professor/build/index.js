...
function EditComponent(props) {
  const [thePerview, setThePerview] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
  ...
  function updateTheMeta() {
    ...
    const profsForMeta = allBlocks.filter(x => x.name === 'ourplugin/featured-professor').map(x => x.attributes.profId).filter((x, index, arr) => {
