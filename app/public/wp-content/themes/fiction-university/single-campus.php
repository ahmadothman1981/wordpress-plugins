...
<div class="container container--narrow page-section">
    ...
    <div class="generic-content" >
     ...
     <?php
     $relatedPrgram = new WP_Query(array(
         'posts_per_page' => -1,
         'post_type' => 'program' ,
         'orderby' =>'title',
         'order' => 'ASC',
     ...
     if($relatedPrgram->have_posts())
     {
         echo '<hr class="section-break ">';
         echo '<h2 class= "headline headline--small">Programs Available in this Campus </h2>';
         echo '<ul class="min-list link-list">';
         
         while($relatedPrgram->have_posts())
         {
             $relatedPrgram->the_post(); ?>
