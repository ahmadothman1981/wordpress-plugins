    ...
    <div class="full-width-split group">
      <div class="full-width-split__one">
        <div class="full-width-split__inner">
          ...
          <p class="t-center no-margin"><a
                  href="<?php echo get_post_type_archive_link('event');//echo site_url('/events') ?>" class="btn btn--blue">
                  View All Events</a></p>
        </div>
      </div>
      <div class="full-width-split__two">
        <div class="full-width-split__inner">
          ...
          <?php
          //custom query to spaciefy what we need to show in the page 
          $homepagePosts = new WP_Query(array(
              'posts_per_page' => 2,
              //we can add another parameter to show spacific category to show for example
          ...
          <div class="event-summary">
            ...
            <div class="event-summary__content">
              ...
              <p><?php  if(has_excerpt())
                    ...
                    //display 18 words from blog description ?>
